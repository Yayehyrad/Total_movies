...
import { HorizontalScollCardInterface } from './HorizontalScrollCard'
import { RootState } from '../store/store'

interface cardInterface extends HorizontalScollCardInterface {
    data  : any
    index : number
}

const Card = ({data,trending,index,media_type } : cardInterface ) => {
