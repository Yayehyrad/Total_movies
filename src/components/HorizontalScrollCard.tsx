...
export interface HorizontalScollCardInterface{
    data : any[] , 
    heading ?: string ,
    trending ?: boolean , 
    media_type ?: string , 
...
const HorizontalScollCard = ({data = [], heading, trending, media_type} : HorizontalScollCardInterface) => {
    const contaierRef = useRef<any>()
